...
int main() {
	...
	*/
	...
	//m.convertToRagged();
	m.resizeRow(1,3); //altera o numero de colunas na linha (primeiro argumento) para o valor do segundo argumento. Caso o número de colunas aumente, os novos elementos sao 
	...
	m.print();
	cout << "\n";
	//m.set(1,2, 1); //altera o valor do elemento na linha 1, coluna 4 para 9
	m.convertToRagged();
